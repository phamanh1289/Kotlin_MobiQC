 ...
 */
class AllCheckListPresenter @Inject constructor(private val apiService: ApiService, private val apiMobiNet: ApiMobiNetService) : BasePresenter<AllCheckListContract.AllCheckListView>(), AllCheckListContract.AllCheckListPresenter {
