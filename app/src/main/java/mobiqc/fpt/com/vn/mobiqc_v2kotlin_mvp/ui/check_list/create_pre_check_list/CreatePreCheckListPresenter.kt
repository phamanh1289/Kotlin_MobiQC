 ...
 */
class CreatePreCheckListPresenter @Inject constructor(private val apiService: ApiService, private val apiMobiNet: ApiMobiNetService, private val apiWsMobiNetService: ApiWsMobiNetService): BasePresenter<CreatePreCheckListContract.CreatePreCheckListView>(), CreatePreCheckListContract.CreatePreCheckListPresenter  {
